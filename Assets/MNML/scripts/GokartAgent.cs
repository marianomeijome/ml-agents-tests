...
namespace Gokart
{
    public class GokartAgent : Agent
    {
        ...
        [Tooltip("The gokart mesh that will disappear on explosion")]
        ...
        // Whether the gokart is frozen (intentionally not flying)
        ...
        public override void InitializeAgent()
        {
            ...
            area = GetComponentInParent<GokartArea>();
        ...
        {
            // Observe gokart velocity (1 vector3 = 3 values)
        ...
        /// <summary>
        /// Resets the gokart to the most recent complete checkpoint
        /// </summary>
        ...
        private IEnumerator ExplosionReset()
        {
            ...
            // Disable gokart mesh object, enable explosion
            meshObject.SetActive(false);
            explosionEffect.SetActive(true);
            yield return new WaitForSeconds(2f);

            // Disable explosion, re-enable gokart mesh
